...
export function TestimonyEntry({
  ...
  return (
    <div
      onClick={() => onOpen?.(t.id)}
      className="relative p-[16px] rounded-[8px] cursor-pointer before:pointer-events-none before:absolute before:inset-0 before:rounded-[8px] before:bg-[rgba(0,0,0,0.05)] before:opacity-0 before:transition-opacity hover:before:opacity-100"
    >
