...
import { WHAT_YOUR_VOTE_DOES } from "../../data/tax-rebate-62f/official-2026";
        ...
        <Split
          ...
          left={
            <p className="font-body text-lg sm:text-xl text-ink leading-[1.5] text-pretty">
              {WHAT_YOUR_VOTE_DOES.yes}
            </p>
          }
          right={
            <p className="font-body text-lg sm:text-xl text-ink leading-[1.5] text-pretty">
              {WHAT_YOUR_VOTE_DOES.no}
            </p>
          }
        />
        {/* Who wrote this, under it. These two sentences are not the page's
            reading of the question, they are the statutory text, and a reader
            who cannot tell the difference cannot weigh them properly. */}
        <p className="font-body text-xs text-ink-muted leading-[1.6] mt-[14px] max-w-[74ch]">
...
export function TaxRebate62FAlt2() {
...
export default TaxRebate62FAlt2;
