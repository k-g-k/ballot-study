...
export function OfficialStatementLine({
  ...
  return (
    <div className="border-l-[3px] border-official pl-[14px]">
      <p className="font-body font-semibold text-sm text-ink-muted mb-[4px]">
        Official Statement
      </p>
      <p className="font-body italic text-base text-ink leading-[1.55]">
        “{text}”
      </p>
      <p className="font-body text-xs text-ink-muted mt-[3px]">
        — {who}
      </p>
    </div>
  );
...
export function VoteCard({
  ...
  return (
    <div className="bg-surface rounded-control p-[24px] flex-1 flex flex-col gap-[20px]">
      <div className="flex items-center gap-[10px]">
        {isYes ? (
          <Check className="w-[24px] h-[24px] text-ink shrink-0" />
        ) : (
          <X className="w-[24px] h-[24px] text-ink shrink-0" />
        )}
      ...
      <p
        data-vote-summary
        className="font-body text-base text-ink leading-[1.5]"
      >
        {d.summary}
        ...
        <div>
          ...
          >
            <button
              ...
              className="group inline-flex items-center gap-[5px] text-left whitespace-nowrap font-body font-semibold text-xl text-brand hover:text-brand-hover hover:font-semibold cursor-pointer"
            >
              {d.funding}
            ...
            {d.fundingCash && d.fundingInKind && (
              <div
                ...
                } hidden group-hover:block w-[260px] bg-surface border border-line-strong rounded-control shadow-[0_10px_28px_rgba(0,0,0,0.14)] p-[12px] z-30 text-left font-body text-xs text-ink leading-[1.5] pointer-events-none`}
              >
                ...
                <span className="block mt-[8px]">
                  <span className="font-semibold">{d.fundingInKind}</span> in-kind
                </span>
                <span className="block text-ink-muted">
      ...
      <div>
        ...
        <div className="flex items-center flex-wrap gap-[6px]">
          ...
          <button
            ...
            className="group font-body font-semibold text-sm text-brand hover:text-brand-hover hover:font-semibold cursor-pointer inline-flex items-center gap-[4px] ml-[0]"
          >
            View Testimony
