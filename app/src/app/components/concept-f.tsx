...
// SCHEMATIC VERSION - Commented out for reference
// function ForAgainstTabSchematic() { ... }

function ForAgainstTab() {
  return (
    <div className="flex flex-col gap-[16px]">
      {/* Official Campaign Positions — Side by Side */}
      <div className="flex gap-[16px]">
        {/* YES Campaign */}
        <div className="bg-white rounded-[8px] p-[24px] flex-1">
          <h3 className="font-['Nunito'] font-semibold text-[18px] text-black mb-[16px]">YES Campaign</h3>
          ...
          <div className="mb-[16px]">
            <p className="font-['Nunito'] font-semibold text-[14px] text-[#606060] mb-[4px]">Official Position</p>
          ...
          <div className="mb-[16px]">
            <p className="font-['Nunito'] font-semibold text-[14px] text-[#606060] mb-[8px]">Endorsing Organizations (12)</p>
            <div className="flex flex-wrap gap-[6px]">
              <span className="bg-[#f0f0f0] px-[10px] py-[4px] rounded-[4px] font-['Nunito'] text-[13px] text-black">Common Cause MA</span>
              <span className="bg-[#f0f0f0] px-[10px] py-[4px] rounded-[4px] font-['Nunito'] text-[13px] text-black">MassPIRG</span>
              <span className="bg-[#f0f0f0] px-[10px] py-[4px] rounded-[4px] font-['Nunito'] text-[13px] text-black">Progressive Mass</span>
              <a href="#" className="text-[#12266f] underline font-['Nunito'] text-[13px]">+9 more</a>
            </div>
          </div>

          <div>
            <p className="font-['Nunito'] font-semibold text-[14px] text-[#606060] mb-[8px]">Elected Officials (3)</p>
            <div className="space-y-[4px]">
              <p className="font-['Nunito'] text-[14px] text-black">State Auditor Diana DiZoglio</p>
              <p className="font-['Nunito'] text-[14px] text-black">Rep. Erika Uyterhoeven</p>
              <a href="#" className="text-[#12266f] underline font-['Nunito'] text-[13px]">+1 more</a>
            </div>
          </div>
        </div>
        ...
        {/* NO Campaign */}
        <div className="bg-white rounded-[8px] p-[24px] flex-1">
          <h3 className="font-['Nunito'] font-semibold text-[18px] text-black mb-[16px]">NO Campaign</h3>
          ...
          <div className="mb-[16px]">
            <p className="font-['Nunito'] font-semibold text-[14px] text-[#606060] mb-[8px]">Opposing Organizations (1)</p>
            <div className="flex flex-wrap gap-[6px]">
              <span className="bg-[#f0f0f0] px-[10px] py-[4px] rounded-[4px] font-['Nunito'] text-[13px] text-black">MA Senate Leadership</span>
            </div>
          </div>

          <div>
            <p className="font-['Nunito'] font-semibold text-[14px] text-[#606060] mb-[8px]">Elected Officials (0)</p>
            <p className="font-['Nunito'] text-[14px] text-[#808080] italic">No elected officials have publicly opposed</p>
          </div>
        </div>
      </div>
      <p className="font-['Nunito'] text-[13px] text-[#808080] italic px-[8px]">
        Side-by-side layout allows direct comparison of official campaign positions for voters who want to weigh advocacy equally before consulting evidence.
      </p>

      {/* Research & Evidence — Neutral Ground */}
      <div className="bg-white rounded-[8px] p-[24px]">
      ...
      <p className="font-['Nunito'] text-[13px] text-[#808080] italic px-[8px]">
        Research presented in a single column as neutral, non-partisan material — no YES/NO framing to avoid suggesting evidence "belongs to" one side.
      </p>

      {/* AI Synthesis of Arguments — Side by Side */}
      <div className="flex gap-[16px]">
        <div className="bg-[#f5f3ff] border border-[#d8b4fe] rounded-[8px] p-[24px] flex-1">
          <h3 className="font-['Nunito'] font-semibold text-[18px] text-[#6b21a8] mb-[16px]">Strongest YES Arguments</h3>
        ...
        <div className="bg-[#f5f3ff] border border-[#d8b4fe] rounded-[8px] p-[24px] flex-1">
          <h3 className="font-['Nunito'] font-semibold text-[18px] text-[#6b21a8] mb-[16px]">Strongest NO Arguments</h3>
          <div className="space-y-[12px]">
            <div>
              <p className="font-['Nunito'] font-semibold text-[14px] text-black mb-[4px]">
      ...
      <p className="font-['Nunito'] text-[13px] text-[#808080] italic px-[8px]">
        Parallel AI synthesis of arguments maintains the comparison structure, but visually distinct from official positions to signal this is navigation aid, not advocacy.
      </p>

      {/* Consensus & Analysis — Single Column */}
      <div className="bg-white rounded-[8px] p-[24px]">
